...
/*
Time complexity: O(2^N), where N is the number of elements present in the given array.
Space complexity: O(N) auxiliary stack space.
*/

/*
Top dowm memoization solution.
*/
...
/*
Time complexity: O(N*N*N), where N is the number of elements present in the given array.
...
/*
Time complexity: O(N^3), where N is the number of elements present in the given array.
Space complexity: O(N*N) for the DP array and please note here that we are not using any extra auxiliary stack space over here.
*/