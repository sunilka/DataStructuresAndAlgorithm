...
int minDays(vector<int>& bloomDay, int m, int k) {
    int n = bloomDay.size(), ans = *max_element(bloomDay.begin(), bloomDay.end());
...
Time complexity: O(NlogT), where T is the max time present to bloom in the bloomDay vector and N is the number of elements present in the bloomDay vector.
